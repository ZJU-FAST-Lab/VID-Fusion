...
class Estimator
{
  public:
    ...
    double sum_dt_preintegration_force; // time offset between 2 img frames
    ...
    vector<double> Fz_avg_vector;  //Fz_avg for average Fz in between Windows
    double Fz_avg; //Fz_avg for average Fz in between Windows
